    ...
    // Admin routes
    {
        ...
        children   : [
...

            {
                ...
                loadChildren: () => import('app/modules/admin/salaire-aller/salaire-aller.module').then(m => m.SalaireAllerModule)
            },
...

            {
                ...
                loadChildren: () => import('app/modules/admin/traitement-salaire/traitement-salaire.module').then(m => m.SalaireTraitementModule)
            },
            ...
            },
            {
                ...
                loadChildren: () => import('app/modules/admin/valider-prelevement-interbancaire/valider-prelevement-interbancaire.module').then(m => m.PrelevementValiderInterbancaireModule)
            },
            {
