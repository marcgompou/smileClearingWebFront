                ...
                (response) => {// en cas d'erreurs, il entre ici
                    ...
                    switch (response.status) {
                        case 400:
                            ...
                            break;
                        case 500:
                            this.displayErrors("Erreur interne du serveur, veuillez contacter le service informatique !");
                            break;
                        default:
                            this.displayErrors("Impossible d'établir la connexion,veuillez verifier vos paramètres reseaux");
                            break;
                    }
                }
            );
