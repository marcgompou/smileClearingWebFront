...
export class DetailsPrelevementInterbancaireComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._validerPrelevementInterbancaireService.prelevementRemise$
  ...
  validerPrelevement() {
    ...
    this._validerPrelevementInterbancaireService
      .validerPrelevement(this.prelevementInterbancaireData.id)
      .pipe()
      .subscribe({
        next: (response) => {
  ...
  telechargerPrelevement(): void {
    this._validerPrelevementInterbancaireService
      .telechargerRetourPrelevement(this.prelevementInterbancaireData.id)
      .pipe()
      .subscribe((blob) => {
  ...
  telechargerRelance(): void {
    this._validerPrelevementInterbancaireService
      .telechargerRelance(this.prelevementInterbancaireData.id)
      .pipe()
      .subscribe();
  }
}
