...
export class ImprimerRemiseService {
  ...
  getEntreprise(): Observable<any> {
    return this._httpClient
      .get<any>(`${environment.apiUrl}/entreprises/all`)
      .pipe(
        tap((response) => {
          console.log("test======================================");
          console.log(response);
  ...
  getEntrepriseById(identreprise: string): Observable<any> {
    return this._httpClient
      .get<any>(`${environment.apiUrl}/entreprises/?id=${identreprise}`)
      .pipe(
        tap((response) => {
          console.log("test======================================");
          console.log(response);
  ...
  getRemiseImprimer(idExportation: string): Observable<any> {
    return this._httpClient
      .get<any>(`${environment.apiUrl}/exportation/${idExportation}/cheques`)
      .pipe(
        tap((response) => {
          console.log("=======test======================================");
          console.log(response);
