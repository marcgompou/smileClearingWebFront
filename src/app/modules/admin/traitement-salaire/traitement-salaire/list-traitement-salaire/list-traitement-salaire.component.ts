...
@Component({
  ...
  templateUrl: './list-traitement-salaire.component.html',
  styleUrls: ['list-traitement-salaire.component.scss'],
...
export class ListTraitementSalaireComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  loadCompte() {
    this._traitementSalaireService.compteEntreprises$.pipe(takeUntil(this._unsubscribeAll)
    ).subscribe({
      next: (response: any) => {
