...
export class UtilisateursCreateComponent implements OnInit, OnDestroy
{
    ...
    isNotUserAdmin=true;
    rolesList: string[] =  ['CHARG_PRELEVEMENT','VISUALISATION','EXPORTATION','VALID_PRELEVEMENT','VALIDATION','SUPERADMIN','CREATION','ADMIN','VALID_PRELEVEMENT_INTER_BANK','CONSULT_AFB120','CHARG_PRELEVEMENT_INTER_BANK','CHARG_SALAIRE','CONSULT_SALAIRE','CONSULT_VALEUR_SALAIRE','VALID_SALAIRE'];
    disabledOptions:string[]=[];
    rolesForNonAdmin=['CHARG_PRELEVEMENT','EXPORTATION','VALID_PRELEVEMENT','VALIDATION','CREATION','VALID_PRELEVEMENT_INTER_BANK','CONSULT_AFB120','CHARG_PRELEVEMENT_INTER_BANK','CHARG_SALAIRE','VALIDATION_SALAIRE'];
