    ...
    openDetailComponent(component: DetailsComponent) {
        ...
        component.formFields = [
          ...
          },
          {
            ...
            type:"select",
            multiple:true,
            options:['CHARG_PRELEVEMENT','VISUALISATION','EXPORTATION','VALID_PRELEVEMENT','VALIDATION','SUPERADMIN','CREATION','ADMIN','VALID_PRELEVEMENT_INTER_BANK','CHARG_AFB120','CHARG_PRELEVEMENT_INTER_BANK','CHARG_SALAIRE','CONSULT_VALEUR_SALAIRE','CONSULT_SALAIRE','VALID_SALAIRE'],
            validators: {
              max: 130,
              required: true,
            }
