...
export const faqs = [
    ...
    },
    {
        ...
        categoryId: '28924eab-97cc-465a-ba21-f232bb95843f',
        question  : 'Comment puis-je numériser un chèque avec votre solution?',
        answer    : '- Assurez-vous que votre scanner est correctement configuré et connecté à votre système informatique .\n\n - Ouvrez le logiciel de digitalisation de chèques sur votre ordinateur.\n\n - Ouvrez le logiciel de digitalisation de chèques sur votre ordinateur.\n\n - Placez physiquement le chèque sur le scanner, en vous assurant que le chèque est bien aligné . \n\n -  Lancez le processus de numérisation à partir du logiciel et vérifiez l\'image du chèque avant d\'enregistrer.'
    },
    {
        id        : '2e6971cd-49d5-49f1-8cbd-fba5c71e6062',
        categoryId: '28924eab-97cc-465a-ba21-f232bb95843f',
        question  : 'Quels types de scanners sont compatibles avec votre solution de digitalisation de chèques?',
        answer    : 'Nous prenons en charge une gamme variée de scanners chèques, parmi lesquels figurent des marques renommées telles que DigitalChecks, SEAC, CANON, et d\'autres. Cette diversité nous permet de répondre aux besoins spécifiques de nos utilisateurs. Nous collaborons étroitement avec les fabricants de scanners pour garantir une intégration fluide et une compatibilité optimale avec notre logiciel.'
    },
    {
        id        : '974f93b8-336f-4eec-b011-9ddb412ee828',
        categoryId: '28924eab-97cc-465a-ba21-f232bb95843f',
        question  : 'Comment puis-je vérifier l\'état de traitement d\'un chèque après l\'avoir numérisé?',
        answer    : ' Apres 48H si le chèque n\'est pas revenu impayé alors il est validé et comptabilisé vous pouvez le revoir sous le menu <Valider Remise> - <Imprimer Remise>.'
    },
    {
        id        : '5d877fc7-b881-4527-a6aa-d39d642feb23',
        categoryId: '28924eab-97cc-465a-ba21-f232bb95843f',
        question  : 'Que faire si un chèque est rejeté et ne peut pas être numérisé?',
        answer    : 'si un chèque est rejeté et ne peut pas être numérisé, vous pouvez contacter le service client pour assistance <Contact: support@neofinancialsolutions.com ou 07 05 74 99 79 38 >.'
    },
    // General inquiries
    {
        id        : '3d1c26c5-1e5e-4eb6-8006-ed6037ed9aca',
        categoryId: '395b0d41-b9a8-4cd6-8b5c-f07855e82d62',
        question  : 'Quelles sont les étapes pour déposer électroniquement un chèque dans le système bancaire?',
        answer    : 'La première étape est le scanne du chèque et la seconde , la validation du chèque par le N+1 qui confirme le dépot du chèque à la banque.'
    },
    {
        id        : '11bd2b9a-85b4-41c9-832c-bd600dfa3a52',
        categoryId: '395b0d41-b9a8-4cd6-8b5c-f07855e82d62',
        question  : 'Comment puis-je obtenir une confirmation de dépôt réussi?',
        answer    : 'Les informations de dépôt sont envoyées par mail à la banque et à vous même lors de la validation .'
    },
    {
        id        : 'f55c023a-785e-4f0f-b5b7-47da75224deb',
        categoryId: '395b0d41-b9a8-4cd6-8b5c-f07855e82d62',
        question  : 'Quels sont les délais de traitement des chèques numérisés?',
        answer    : 'Le delai est de 48H apres la validation du chèque.'
    },
    {
        id        : 'c577a67d-357a-4b88-96e8-a0ee1fe9162e',
        categoryId: '395b0d41-b9a8-4cd6-8b5c-f07855e82d62',
        question  : 'Quel est le delai de validation dans la journée?',
        answer    : 'Le dernier delai de validation des chèques est à 16H00 ,neamoins les chèques validé apres 16H00 sont considérés comme des chèques pour le lendemain.'
    },
    {
        id        : '1a680c29-7ece-4a80-9709-277ad4da8b4b',
        categoryId: '395b0d41-b9a8-4cd6-8b5c-f07855e82d62',
        question  : 'Pouvons nous scanner les Samedis?',
        answer    : 'Oui il est permis de scanner les samedis de 09H à 15H , mais cela sera pris en compte pour le lundi suivant.'
    },
    ...
    // Licenses
    {
        ...
        question  : 'Comment fonctionnent les licences?',
        answer    : 'Nous avons une licence par module, la licence du module de gestion des chèques et prélèvement est offerte par la banque, la licence du module de comptabilité donnant acces au AFB120 et MT940 est payant par acquisition de l\'entreprise.'
    },
    {
        id        : '7bc6b7b4-7ad8-4cbe-af36-7301642d35fb',
        categoryId: 'b388a87f-bfbb-44d0-800c-0ddbce2a5d22',
        question  : 'Avons-nous une date d\'expiration de la licence?',
        answer    : 'le licence acquise sont définitif avec  un support annuel de 20% du prix d\'acquisition.'
    },
